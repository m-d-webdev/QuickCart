    ...
    if (isWorkingOnPC) {
        ...
        return (
            <>
                {isLoaing ? <div className="spinner2 w20 h20"></div> :
                    isAlreadyIn ?
                        <div className="c-s-s wmia BtnAddddToooCart mt15">
                            {
                                !idLoading2 &&
                                <p className="mb5 activeCmp"><strong>{userCart.filter(elm => elm.prodId == prod_id)[0]?.quantity} </strong>Items in the Cart</p>
                            }
                            <div className="r-s-c  wmia" >
                                <button  className='tbnAddToCArt activeCmp' onClick={handelIncreaseQuantity}  >
                                    {idLoading2 ?
                                ...
                                <span className="sayRemoveFromCart ml10 bg-r br5 w30 r-c-c p5" onClick={handelRemoveQuantity}><svg xmlns="http://www.w3.org/2000/svg" style={{fill:"#fff"}} viewBox="0 -960 960 960" width="24px" fill="#000000"><path d="M280-120q-33 0-56.5-23.5T200-200v-520h-40v-80h200v-40h240v40h200v80h-40v520q0 33-23.5 56.5T680-120H280Zm400-600H280v520h400v-520ZM360-280h80v-360h-80v360Zm160 0h80v-360h-80v360ZM280-720v520-520Z"/></svg></span>
                            </div>
                        </div >
                        :
        ...
        return (
            <>
                {isLoaing ? <div className="spinner2 w20 h20"></div> :
                    isAlreadyIn ?
                        <div className="c-s-s BtnAddddToooCart mt15 " >
                            {
                                !idLoading2 &&
                                <p className="mb5 activeCmp"><strong>{userCart.filter(elm => elm.prodId == prod_id)[0]?.quantity} </strong>Items in the Cart</p>
                            }
