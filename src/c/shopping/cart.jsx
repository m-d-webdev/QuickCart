...
function cart() {
    ...
    const CartItem = ({ data }) => {
        const { isLoadingData, productsList } = useSelector(st => st.productsManager)
                            ...
                            <>
                                <div className="c-s-s ml15 wmia">
                                    ...
                                    <button className='br br20 w200 mt50' onClick={getProdLikeThis}>
                                        <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#000000"><path d="M200-120v-440h80v360h360v80H200Zm200-200v-440h80v360h360v80H400Z" /></svg>
                                        More like this
                                    </button>
